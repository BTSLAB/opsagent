...
import { removeAckReactionAfterReply, shouldAckReaction } from "opsagent/plugin-sdk";
...
function createMockRuntime(): PluginRuntime {
  return {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/opsagent") as unknown as PluginRuntime["state"]["resolveStateDir"],
    },
  };
}
