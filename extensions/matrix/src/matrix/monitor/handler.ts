...
export type MatrixMonitorHandlerParams = {
  ...
  core: {
    ...
    channel: typeof import("opsagent/plugin-sdk")["channel"];
    system: {
      enqueueSystemEvent: (
        text: string,
  ...
  mentionRegexes: ReturnType<
    typeof import("opsagent/plugin-sdk")["channel"]["mentions"]["buildMentionRegexes"]
  >;
                ...
                try {
                  await sendMessageMatrix(
                    ...
                    [
                      ...
                      "opsagent pairing approve matrix <code>",
                    ].join("\n"),
                    { client },
                  );
                } catch (err) {
