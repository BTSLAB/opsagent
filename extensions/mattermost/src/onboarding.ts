import type { ChannelOnboardingAdapter, OpsAgentConfig, WizardPrompter } from "opsagent/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.opsagent.dev/channels/mattermost",
    ].join("\n"),
