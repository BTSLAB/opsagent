...
Nostr DM channel plugin for OpsAgent using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to OpsAgent. It enables your bot to:
...
```bash
opsagent plugins install @opsagent/nostr
```
...
# Configure opsagent to use local relay
