...
export function resolveTlonAccount(cfg: OpsAgentConfig, accountId?: string | null): TlonResolvedAccount {
...
export function listTlonAccountIds(cfg: OpsAgentConfig): string[] {
  const base = cfg.channels?.tlon as
