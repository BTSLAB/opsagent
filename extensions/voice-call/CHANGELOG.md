...
### Changes
- Version alignment with core OpsAgent release numbers.
...
### Highlights
- First public release of the @opsagent/voice-call plugin.
...
- CLI: `opsagent voicecall` commands (call/start/continue/speak/end/status/tail/expose).
