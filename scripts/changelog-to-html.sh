...
if [[ -z "$version_content" ]]; then
  echo "<h2>OpsAgent $VERSION</h2>"
  echo "<p>Latest OpsAgent update.</p>"
  echo "<p><a href=\"https://github.com/opsagent/opsagent/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
