...
# Output:
# - dist/OpsAgent.app
# - dist/OpsAgent-<version>.zip
# - dist/OpsAgent-<version>.dmg
...
APP="$ROOT_DIR/dist/OpsAgent.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/OpsAgent-$VERSION.zip"
DMG="$ROOT_DIR/dist/OpsAgent-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/OpsAgent-$VERSION.notary.zip"
