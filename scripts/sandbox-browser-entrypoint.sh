...
export DISPLAY=:1
export HOME=/tmp/opsagent-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${OPSAGENT_BROWSER_CDP_PORT:-9222}"
VNC_PORT="${OPSAGENT_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${OPSAGENT_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${OPSAGENT_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${OPSAGENT_BROWSER_HEADLESS:-0}"
