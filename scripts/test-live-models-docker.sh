...
docker run --rm -t \
  ...
  -e OPSAGENT_LIVE_MODELS="${OPSAGENT_LIVE_MODELS:-all}" \
  -e OPSAGENT_LIVE_PROVIDERS="${OPSAGENT_LIVE_PROVIDERS:-}" \
  -e OPSAGENT_LIVE_MODEL_TIMEOUT_MS="${OPSAGENT_LIVE_MODEL_TIMEOUT_MS:-}" \
  -e OPSAGENT_LIVE_REQUIRE_PROFILE_KEYS="${OPSAGENT_LIVE_REQUIRE_PROFILE_KEYS:-}" \
