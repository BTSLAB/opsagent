# Contributing to OpsAgent Security Suite
...
- Edge case discovery
- Integration testing with various OpsAgent setups
...
# See: https://docs.opsagent.dev/install
```
...
# Test installation
~/.opsagent/skills/security/security help
```
...
~/.opsagent/skills/security/security validate-command "your_malicious_example"

# Test benign input (should allow)  
~/.opsagent/skills/security/security validate-command "your_benign_example"

# Performance test
time ~/.opsagent/skills/security/security validate-command "test_command"
```
...
**Technical questions**: [GitHub Discussions](https://github.com/gtrusler/opsagent-security-suite/discussions)  
