...
We take security seriously. If you discover a security vulnerability in the OpsAgent Security Suite, please report it responsibly.
...
2. **Subject**: "SECURITY: OpsAgent Security Suite Vulnerability"
3. **Include**:
...
- **Your environment** (OS, OpsAgent version, etc.)
...
❌ **Out of scope**:
- General OpsAgent vulnerabilities (report to OpsAgent project)
...
General issues: [GitHub Issues](https://github.com/gtrusler/opsagent-security-suite/issues)  
