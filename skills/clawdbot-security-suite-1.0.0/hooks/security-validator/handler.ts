...
const CONFIG = {
  ...
  blockThreats: true,
  logEvents: true,
  securitySkillPath: join(homedir(), '.opsagent', 'skills', 'security', 'security'),
  logFile: join(homedir(), '.opsagent', 'logs', 'security-events.log')
};

// Ensure log directory exists
const logDir = join(homedir(), '.opsagent', 'logs');
