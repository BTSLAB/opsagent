---
name: security
description: Advanced security validation for OpsAgent - pattern detection, command sanitization, and threat monitoring
homepage: https://github.com/gtrusler/opsagent-security
metadata: {"opsagent":{"emoji":"🔒","requires":{"bins":["jq"]}}}
---
...
See `OPSAGENT-INSTRUCTIONS.md` for complete agent integration guide.
...
cp -r security.sh ~/.opsagent/skills/
