...
- Read ~/.opsagent/linkedin-monitor/state/messages.json
...
- Read alertChannel and alertTarget from ~/.opsagent/linkedin-monitor/config.json
...
- Write to ~/.opsagent/linkedin-monitor/state/messages.json
