...
function resolveAvatarSource(cfg: OpsAgentConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: OpsAgentConfig, agentId: string): AgentAvatarResolution {
