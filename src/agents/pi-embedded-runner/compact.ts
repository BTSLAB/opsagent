...
import { resolveOpsAgentDocsPath } from "../docs-path.js";
...
export async function compactEmbeddedPiSessionDirect(
  ...
  const agentDir = params.agentDir ?? resolveOpsAgentAgentDir();
  await ensureOpsAgentModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createOpsAgentCodingTools({
      exec: {
    ...
    const docsPath = await resolveOpsAgentDocsPath({
      workspaceDir: effectiveWorkspace,
