...
describe("createOpsAgentCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createOpsAgentCodingTools({
      config,
    ...
    const anthropicTools = createOpsAgentCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createOpsAgentCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createOpsAgentCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
