...
import { STATE_DIR_OPSAGENT } from "../../config/config.js";

export const DEFAULT_SANDBOX_WORKSPACE_ROOT = path.join(os.homedir(), ".opsagent", "sandboxes");

export const DEFAULT_SANDBOX_IMAGE = "opsagent-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "opsagent-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "opsagent-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "opsagent-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "opsagent-sbx-browser-";
...
const resolvedSandboxStateDir = STATE_DIR_OPSAGENT ?? path.join(os.homedir(), ".opsagent");
