...
function resolveWatchPaths(workspaceDir: string, config?: OpsAgentConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: OpsAgentConfig }) {
