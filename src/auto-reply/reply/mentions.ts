...
function resolveMentionPatterns(cfg: OpsAgentConfig | undefined, agentId?: string): string[] {
  if (!cfg) return [];
...
export function buildMentionRegexes(cfg: OpsAgentConfig | undefined, agentId?: string): RegExp[] {
