...
describe("browser client", () => {
  ...
  it("adds Authorization when OPSAGENT_BROWSER_CONTROL_TOKEN is set", async () => {
    const prev = process.env.OPSAGENT_BROWSER_CONTROL_TOKEN;
    process.env.OPSAGENT_BROWSER_CONTROL_TOKEN = "t1";
    ...
    process.env.OPSAGENT_BROWSER_CONTROL_TOKEN = prev;
  });
