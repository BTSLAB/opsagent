...
describe("browser config", () => {
  ...
  it("derives default ports from OPSAGENT_GATEWAY_PORT when unset", () => {
    const prev = process.env.OPSAGENT_GATEWAY_PORT;
    process.env.OPSAGENT_GATEWAY_PORT = "19001";
    try {
      const resolved = resolveBrowserConfig(undefined);
      ...
      if (prev === undefined) {
        ...
        process.env.OPSAGENT_GATEWAY_PORT = prev;
      }
    }
  });
