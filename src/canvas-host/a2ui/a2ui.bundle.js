...
var OpsAgentA2UIHost = class extends i$6 {
	static properties = {
		surfaces: { state: true },
    ...
    :host {
      ...
      box-sizing: border-box;
      padding:
        var(--opsagent-a2ui-inset-top, 0px)
        var(--opsagent-a2ui-inset-right, 0px)
        var(--opsagent-a2ui-inset-bottom, 0px)
        var(--opsagent-a2ui-inset-left, 0px);
    }
    ...
    #surfaces {
      ...
      height: 100%;
      overflow: auto;
      padding-bottom: var(--opsagent-a2ui-scroll-pad-bottom, 0px);
    }
    ...
    .status {
      ...
      top: var(--opsagent-a2ui-status-top, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .toast {
      ...
      left: 50%;
      transform: translateX(-50%);
      bottom: var(--opsagent-a2ui-toast-bottom, 12px);
      display: inline-flex;
      align-items: center;
      gap: 8px;
      padding: 8px 10px;
    ...
    .empty {
      ...
      left: 50%;
      transform: translateX(-50%);
      top: var(--opsagent-a2ui-empty-top, var(--opsagent-a2ui-status-top, 12px));
      text-align: center;
      opacity: 0.8;
      padding: 10px 12px;
      pointer-events: none;
  ...
  `;
	connectedCallback() {
		...
		globalThis.addEventListener("opsagent:a2ui-action-status", this.#statusListener);
		this.#syncSurfaces();
	}
	disconnectedCallback() {
		super.disconnectedCallback();
		if (this.#statusListener) {
			globalThis.removeEventListener("opsagent:a2ui-action-status", this.#statusListener);
	...
	#handleA2UIAction(evt) {
		...
		globalThis.__opsagentLastA2UIAction = userAction;
		const handler = globalThis.webkit?.messageHandlers?.opsagentCanvasA2UIAction ?? globalThis.opsagentCanvasA2UIAction;
		if (handler?.postMessage) {
			try {
				if (handler === globalThis.opsagentCanvasA2UIAction) {
...
customElements.define("opsagent-a2ui-host", OpsAgentA2UIHost);
