...
export function listChannelMessageActions(cfg: OpsAgentConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: OpsAgentConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: OpsAgentConfig): boolean {
  for (const plugin of listChannelPlugins()) {
