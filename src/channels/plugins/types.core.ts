...
export type ChannelAgentToolFactory = (params: { cfg?: OpsAgentConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: OpsAgentConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: OpsAgentConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: OpsAgentConfig }) => boolean;
  supportsCards?: (params: { cfg: OpsAgentConfig }) => boolean;
