const DEFAULT_TAGLINE = "All your chats, one OpsAgent.";
...
const TAGLINES: string[] = [
  "Your terminal just got smarter—type something and let the agent handle the busywork.",
  ...
  "Automation with agents: minimal fuss, maximal impact.",
  ...
  "Agents out, commit in—let's ship something mildly responsible.",
  "I'll grease your workflow like a well-oiled machine: smooth, efficient, effective.",
...
export function pickTagline(options: TaglineOptions = {}): string {
  ...
  const override = env?.OPSAGENT_TAGLINE_INDEX;
