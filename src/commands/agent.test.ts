...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "opsagent-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<OpsAgentConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<OpsAgentConfig["telegram"]>>,
