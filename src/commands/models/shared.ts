...
export async function updateConfig(
  mutator: (cfg: OpsAgentConfig) => OpsAgentConfig,
...
export function resolveModelTarget(params: { raw: string; cfg: OpsAgentConfig }): {
  provider: string;
  model: string;
} {
...
export function buildAllowlistSet(cfg: OpsAgentConfig): Set<string> {
