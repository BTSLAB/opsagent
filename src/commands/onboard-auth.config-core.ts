...
export function applyZaiConfig(cfg: OpsAgentConfig): OpsAgentConfig {
...
export function applyOpenrouterProviderConfig(cfg: OpsAgentConfig): OpsAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: OpsAgentConfig): OpsAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: OpsAgentConfig): OpsAgentConfig {
...
export function applyOpenrouterConfig(cfg: OpsAgentConfig): OpsAgentConfig {
...
export function applyMoonshotProviderConfig(cfg: OpsAgentConfig): OpsAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: OpsAgentConfig): OpsAgentConfig {
...
export function applyKimiCodeProviderConfig(cfg: OpsAgentConfig): OpsAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: OpsAgentConfig): OpsAgentConfig {
...
export function applySyntheticProviderConfig(cfg: OpsAgentConfig): OpsAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: OpsAgentConfig): OpsAgentConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: OpsAgentConfig): OpsAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: OpsAgentConfig): OpsAgentConfig {
