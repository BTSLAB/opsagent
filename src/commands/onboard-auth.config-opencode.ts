...
export function applyOpencodeZenProviderConfig(cfg: OpsAgentConfig): OpsAgentConfig {
...
export function applyOpencodeZenConfig(cfg: OpsAgentConfig): OpsAgentConfig {
