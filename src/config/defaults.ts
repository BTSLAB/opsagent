...
function resolveAnthropicDefaultAuthMode(cfg: OpsAgentConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: OpsAgentConfig): OpsAgentConfig {
...
export function applyTalkApiKey(config: OpsAgentConfig): OpsAgentConfig {
...
export function applyModelDefaults(cfg: OpsAgentConfig): OpsAgentConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: OpsAgentConfig): OpsAgentConfig {
...
export function applyLoggingDefaults(cfg: OpsAgentConfig): OpsAgentConfig {
...
export function applyContextPruningDefaults(cfg: OpsAgentConfig): OpsAgentConfig {
...
export function applyCompactionDefaults(cfg: OpsAgentConfig): OpsAgentConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) return cfg;
