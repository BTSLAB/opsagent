...
import { type OpsAgentConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: OpsAgentConfig): string[] {
...
export function listAgentsForGateway(cfg: OpsAgentConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: OpsAgentConfig): string {
...
function resolveSessionStoreAgentId(cfg: OpsAgentConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: OpsAgentConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: OpsAgentConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: OpsAgentConfig): GatewaySessionsDefaults {
