...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: OpsAgentConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: OpsAgentConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: OpsAgentConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  clear(cfg?: OpsAgentConfig): void {
    this.cache.clear();
    if (cfg) this.lastConfigRef = cfg;
  }

  private resetIfConfigChanged(cfg: OpsAgentConfig): void {
