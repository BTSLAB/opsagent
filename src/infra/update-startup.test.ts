...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "opsagent-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveOpsAgentPackageRoot } = await import("./opsagent-root.js");
    ...
    vi.mocked(resolveOpsAgentPackageRoot).mockResolvedValue("/opt/opsagent");
