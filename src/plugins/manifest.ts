...
export const PLUGIN_MANIFEST_FILENAME = "opsagent.plugin.json";
...
// package.json "opsagent" metadata (used for onboarding/catalog)
...
export type OpsAgentPackageManifest = {
  extensions?: string[];
