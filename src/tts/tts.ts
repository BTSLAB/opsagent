...
export function resolveTtsConfig(cfg: OpsAgentConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.OPSAGENT_TTS_PREFS?.trim();
...
export function buildTtsSystemPromptHint(cfg: OpsAgentConfig): string | undefined {
