...
declare global {
  interface Window {
    __OPSAGENT_ASSISTANT_NAME__?: string;
    __OPSAGENT_ASSISTANT_AVATAR__?: string;
  }
}
...
export function resolveInjectedAssistantIdentity(): AssistantIdentity {
  ...
  return normalizeAssistantIdentity({
    name: window.__OPSAGENT_ASSISTANT_NAME__,
    avatar: window.__OPSAGENT_ASSISTANT_AVATAR__,
  });
}
